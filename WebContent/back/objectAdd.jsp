...
<div class="main">
  ...
  <div class="biaoti">Upload</div>
  <div class="userinfo">
  	<p class="two"> </p>
	<p class="three"> </p>
	<p class="four"> </p>
		<form id="objectAdd" action="${basePath}/store/uploadSingle" enctype="multipart/form-data" method="post">
			<div class="www_zzjs_net">
	   			<span class="userinfotitle">属性一</span>
	   			<!--<select class="se1" id="txtStoreObject" name="name">
		   ...
		   <div class="rou">
		    	<span class="userinfotitle">属性二</span>
		    	<!--<select class="se2" id="txtStoreObjectVersion" name="version">
		   ...
		   <div class="www_zzjs_net">
		    	<span class="userinfotitle">属性三</span>
		    	<!--<select class="se2" id="txtLevel" name="type">
        			<option value="0">--请选择类型--</option>
    	 		</select> -->
    	 		<input type="text" class="se2" id="txtStoreObjectVersion" name="type">
...
<script type="text/javascript">
	...
	$(function(){
		$("#txtStoreObject").focus(
			function(){
				$("#flag0").html("");
			}		
		);
		
		$("#txtStoreObjectVersion").focus(
				function(){
					$("#flag1").html("");
				}	
		);
		
		$("#txtStoreObjectLevel").focus(
				function(){
					$("#flag2").html("");
				}		
		);
